...
import com.ivy.common.androidtest.saveAccountWithTransactions
import com.ivy.common.androidtest.transactionWithTime
...
class HomeScreenTest: IvyAndroidTest(){
    ...
    @Test
    fun testSelectingDataRange() = runBlocking<Unit> {
        ...
        composeRule
            .onNodeWithText("Aug. 01").assertIsDisplayed()
