...
class NewTransactionRobot(
    ...
    private fun enterCategoryName(name: String): NewTransactionRobot {
        //composeRule.onRoot().printToLog("AddingTreeLog")
        //composeRule.onNodeWithContentDescription("New Category").assertIsDisplayed()
    ...
    fun enterTransactionDescription(description: String): NewTransactionRobot{
        ...
        composeRule.onNodeWithContentDescription("Enter any details here")
